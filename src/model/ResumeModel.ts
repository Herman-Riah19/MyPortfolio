...
const diplome: Array<Model> = [
    ...
    },
    {
        ...
        date: "2016-2017",
        institute: "Institut d'Enseignement Technique Amboanjombe, Antananarivo",
...
const formation: Array<Model> = [
    {
        title: "Basic programming training",
        date: "2018-2019",
        institute: "SoloLearn.com, on line",
        description: "Distance training in an American site sololearn.com with a certificate specializing in the basics of programming languages such as Python, C/C++, Javascript and Dart. The goal is to master the basics of programming and also the correct handling of these previous languages before entering the Frameworks"    },
    {
        ...
        date: "2018-2019",
        institute: "Stem for Good, Ankorondrano Antananarivo",
...
const experience: Array<Model> = [
    {
        title: "Developper fullstack",
        date: "2023",
        institute: "Fpay, Andohalo Antananarivo",
    ...
    },
    {
        ...
        date: "2020",
        institute: "Ministry of Technical Education and Vocational Training, Ampefiloha Antananarivo",
...
export {diplome, formation, experience}